...
#ifndef CCAV_AUDIODECODER_H
#define CCAV_AUDIODECODER_H
...
class CCDecodeAudioPrivate;
class Q_EXPORT CCDecodeAudio : public CCDevoder
{
    DPTR_DECLARE_PRIVATE(CCDecodeAudio)
public:
    CCDecodeAudio();
